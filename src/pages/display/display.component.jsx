...
const DisplayPage = () => {
  ...
  return (
    <div className="muxic__display-page__container">
      {isLoading ? (
        <Spinner />
      ) : (
        <>
          <div className="muxic__display-page__container__genres">
            <div className="muxic__display-page__container__genres-text">
              <h1>
                Explore <span>genres</span>
              </h1>
            </div>

            <div className="muxic__display-page__container__genre-navigation">
              <div className="muxic__display-page__container__genre-navigation__back">
                <AiFillLeftCircle onClick={() => handleNav('left')} />
              </div>
              <div
                className="muxic__display-page__container__genres-box"
                ref={navRef}
              >
              ...
              <div className="muxic__display-page__container__genre-navigation__next">
                <AiFillRightCircle onClick={() => handleNav('right')} />
              </div>
            </div>
          </div>
          <div className="muxic__display-page__container__tracks">
            <div className="muxic__display-page__container__genres-text">
              <h1>
                Browse <span>Tracks</span>
              </h1>
            </div>
            <div className="muxic__display-page__container__tracks-box">
              {allTracks.map((track) => (
                <TrackCard
                  name={track?.title}
                  color={randomColor()}
