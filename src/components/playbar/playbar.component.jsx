...
const PlayBar = ({
  ...
  return (
    <div className="muxic__song-playbar__container">
      <div className="muxic_song-playbar__container__details">
        <div className="muxic_song-playbar__container__playNo">
          <p>{playNo}.</p>
        </div>
        <div className="muxic_song-playbar__container__img-div">
          <img src={img} alt={title} />
        </div>
        <div className="muxic_song-playbar__container__desc-div">
          <h5>{title}</h5>
          <p>{subtitle}</p>
        </div>
      </div>
      <div className="muxic_song-playbar__container__btn-div">
        ...
        <div className="muxic_song-playbar__container__btn-div_lyrics">
