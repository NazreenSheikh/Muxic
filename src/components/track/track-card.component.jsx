...
const TrackCard = ({ name, color, img, history }) => {
  ...
  return (
    <div
      className="muxic__track__card-container"
      style={{ backgroundColor: color }}
      onClick={handleClick}
    >
      <div className="muxic__track__text-block">{name}</div>
      <div className="muxic__track__image-block">
        <div className="muxic__track__image">
